...
public class CitrusAmethystClusterBlock extends CitrusAmethystBlock
    ...
    public CitrusAmethystClusterBlock(int height, int xzOffset, AbstractBlock.Settings settings) {
        super(settings);
