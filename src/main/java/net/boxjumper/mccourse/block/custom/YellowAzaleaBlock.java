...
import net.boxjumper.mccourse.world.gen.tree.YellowAzaleaSaplingGenerator;
...
public class YellowAzaleaBlock extends PlantBlock implements Fertilizable {
    private static final YellowAzaleaSaplingGenerator GENERATOR = new YellowAzaleaSaplingGenerator();
